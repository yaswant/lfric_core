...
interface poly1d_flux_kernel_type
   module procedure poly1d_flux_kernel_constructor
end interface
...
type(poly1d_flux_kernel_type) function poly1d_flux_kernel_constructor() result(self)
  implicit none
  return
end function poly1d_flux_kernel_constructor
