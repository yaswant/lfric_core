...
!-----------------------------------------------------------------------------
!
!> @brief A module providing 32-bit integer scalar related classes.
!>
!> @details A representation of a 32-bit integer scalar which provides both easy
...
contains
  ...
  subroutine initialise(self, value, mpi)
    ...
    type(mpi_type), optional, intent(in)    :: mpi
