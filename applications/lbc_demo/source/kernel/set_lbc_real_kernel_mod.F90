...
!-----------------------------------------------------------------------------
module set_lbc_real_kernel_mod
  ...
  type, public, extends(kernel_type) :: set_lbc_real_kernel_type
    private
    type(arg_type) :: meta_args(5) = (/                           &
         arg_type(GH_SCALAR,  GH_INTEGER, GH_READ),               & ! ndata
         arg_type(GH_SCALAR,  GH_LOGICAL, GH_READ),               & ! ndata_first
         arg_type(GH_FIELD,   GH_REAL,    GH_WRITE, ANY_SPACE_8), & ! lbc
  ...
  contains
    procedure, nopass :: set_lbc_real_code
  end type set_lbc_real_kernel_type

  !---------------------------------------------------------------------------
  ! Contained functions/subroutines
  !---------------------------------------------------------------------------
  public :: set_lbc_real_code
...
!! @param[in,out]  lbc         LBC Real field data
...
subroutine set_lbc_real_code( nlayers, ndata, ndata_first, lbc, &
  ...
  real(r_def), dimension(undf),       intent(inout) :: lbc
...
end subroutine set_lbc_real_code

end module set_lbc_real_kernel_mod
