...
module psykal_apply_real_lbc_lite_mod
  ...
  public :: invoke_apply_real_lbc_kernel_type
...
contains
  ...
  !>
  !! @param[in,out] lam_field  Real LAM field to be updated
  !! @param[in]     lbc_field  Real LBC field to apply to real LAM field
  subroutine invoke_apply_real_lbc_kernel_type( lam_field, lbc_field )

    use apply_real_lbc_kernel_mod, only: apply_real_lbc_kernel_code

    implicit none

    type(field_type), intent(inout) :: lam_field      ! Model field to have LBCs updated
    type(field_type), intent(in)    :: lbc_field      ! Driver model LBC field
    ...
    type(field_proxy_type) :: lbc_field_proxy
    type(field_proxy_type) :: lam_field_proxy

    integer(i_def), pointer :: map_adspc1_lam_field(:,:) ! LAM Cell DoF-map
    integer(i_def), pointer :: map_adspc2_lbc_field(:,:) ! LAM Cell DoF-map
    integer(i_def), pointer :: cell_map_lbc_field(:,:,:) ! Inter-Grid cell map
                                                         ! LBC as source
    ...
    do icolour=1, ncolour
      ...
      do cell=1, last_edge_cell_all_colours(icolour)
        ...
        call apply_real_lbc_kernel_code( nlayers,                        &
  ...
  end subroutine invoke_apply_real_lbc_kernel_type

end module psykal_apply_real_lbc_lite_mod
